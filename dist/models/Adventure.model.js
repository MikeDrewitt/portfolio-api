...
function create(adventure) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, typeorm_1.getManager().save(newAdventure)];
        });
    });
}
exports.create = create;
function update(adventure) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, typeorm_1.getManager().save(adventure)];
        });
    });
}
...
function retrieve(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, typeorm_1.getManager().getRepository(Adventure).findOne({ id: id, deletedAt: null })];
        });
    });
}
...
function deleteRecord(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, typeorm_1.getManager().softDelete(Adventure, { id: id })];
        });
    });
}
...
function list(options) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, typeorm_1.getManager().getRepository(Adventure).find(options)];
        });
    });
}
exports.list = list;
